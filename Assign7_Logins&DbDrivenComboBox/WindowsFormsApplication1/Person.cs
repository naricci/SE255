...
namespace WindowsFormsApplication1
{
    ...
    public class Person
    {
        ...
        public Int32 UpdateAContact()
        {
            ...
            string strSQL = "UPDATE Persons SET FName = @FName, MName = @MName, LName = @LName, Street1 = @Street1, Street2 = @Street2, City = @City, State = @State, Zipcode = @Zipcode, Country = @Country, Phone = @Phone, Email = @Email WHERE Person_ID = @Person_ID;";
        ...
        /*
        public static string GetMyPeople()
        {
            //Create my DB objects 
            SqlConnection conn = new SqlConnection();
            SqlCommand comm = new SqlCommand();

            //Create my strings to ontecract with DB objects 
            string strConn = MyUtilities.GetConnected();
            string strSQL = "SELECT FName FROM Persons ORDER BY FName";
